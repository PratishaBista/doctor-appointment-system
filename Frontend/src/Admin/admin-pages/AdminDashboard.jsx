    ...
    <div className="h-[90vh] w-[80vw] p-6 bg-gray-100">
      ...
      >
        ...
        <motion.div 
          ...
          className="flex items-center bg-white shadow-lg rounded-lg p-4 transition"
        >
      ...
      >
        <div className="flex items-center bg-white shadow-md p-4 rounded-lg">
          ...
          <div className="ml-4">
            <h1 className="text-lg font-semibold">Dr. Aadash Khadka</h1>
            <p className="text-gray-500">Booking on 23 March 2025</p>
          </div>
          <img className="h-[50px] ml-auto" src="https://media.istockphoto.com/id/1198849693/vector/cancel-icon-flat-illustration-of-cancel-vector-icon-cancel-sign-symbol-on-white-background.jpg?s=612x612&w=0&k=20&c=6vGokNVvNFp_sudDF_tWWDAtFr1L3lh9JtspLxfwh6Q=" alt="Cancel" />
        </div>

        <div className="mt-4 flex items-center bg-white shadow-md p-4 rounded-lg">
          <img className="h-[70px] rounded-full" src="https://media.istockphoto.com/id/177373093/photo/indian-male-doctor.jpg?s=612x612&w=0&k=20&c=5FkfKdCYERkAg65cQtdqeO_D0JMv6vrEdPw3mX1Lkfg=" alt="Doctor" />
          <div className="ml-4">
            <h1 className="text-lg font-semibold">Dr. Aadash Khadka</h1>
            <p className="text-gray-500">Booking on 23 March 2025</p>
