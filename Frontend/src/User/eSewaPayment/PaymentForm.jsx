        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className={`w-full md:w-1/2 p-8 flex flex-col gap-6 ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
                ...
                <p className="text-sm text-center mb-6">
                    ...
                    <a className="text-green-500 font-semibold cursor-pointer hover:underline">Register</a>
                </p>

                <button className={`font-semibold py-2 hover:underline block mx-auto ${darkMode ? 'text-red-400' : 'text-red-600'}`}>
                    CANCEL PAYMENT
                </button>
                </div>
            </div>
