    ...
    <div className="bg-white w-full shadow-md ">
      <div className="max-w-[2200px] mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center space-x-3">
          <img
            className="h-[45px] w-[45px] rounded-full transform transition "
            onClick={()=>{
              navigate("/")
              scroll(0,0)
            }}
            ...
            alt="Logo"
          />
          <p className="text-2xl font-bold text-[#146A5D] transition duration-300 transform hover:scale-110 hover:text-[#D3D3D3]">
            Green City Hospital
          </p>
        </div>
        ...
        <div className="hidden md:flex space-x-8 font-semibold ">
          ...
          >
            <p className="text-[#146A5D] font-bold">Home</p>
          ...
          >
             <p className="text-[#146A5D] font-bold">Our Services</p>
          ...
          >
             <p className="text-[#146A5D]  font-bold">Contact Us</p>
          ...
          >
             <p className="text-[#146A5D] font-bold"> About Us</p>
        ...
        <div className="flex items-center mr-6">
          <button className="text-l text-white rounded-sm py-2 px-6 hover:bg-[#0F5247] transform transition duration-300 ease-in-out hover:scale-105 bg-[#146A5D]">
