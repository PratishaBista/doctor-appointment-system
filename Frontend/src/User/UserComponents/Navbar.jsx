...
const Navbar = () => {
  ...
  const toggleNotification = (index) => {
    ...
    const markAllAsRead = () => {
    // Update all notifications' status to false
        ...
        <div className="flex items-center mr-6 relative">
          <div ref={notificationRef} className="relative">
            ...
            {notificationDropDown ? (
              <div className="absolute top-[80px] right-[10px] h-[90vh] w-[23rem] bg-white z-50 border border-gray-200 shadow-xl rounded-xl overflow-y-auto">
              ...
              <div className="flex items-center justify-between mb-1">
                <p className="text-sm font-medium text-gray-800 truncate max-w-[80%]">
                  {not.header.length > 50 ? `${not.header.slice(0, 50)}...` : not.header}
                </p>
                <p className="text-xs text-gray-500 ml-2 mb-2 whitespace-nowrap">
                  {not.time}
                </p>
              </div>
