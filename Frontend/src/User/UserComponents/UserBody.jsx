    ...
    <div className='mt-10 flex justify-center'>
      <div className="">
        <div className="relative">
          ...
          {/* Image */}
          <img className='h-[570px] w-[80vw] mt-2 rounded-2xl' src="https://www.shutterstock.com/image-photo/cooperation-people-medical-community-teamwork-600nw-1971770123.jpg" alt="" />
