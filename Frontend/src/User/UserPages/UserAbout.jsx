...
const UserAbout = () => {
  return (
    <div className='p-6 bg-white text-gray-800'>
      ...
      <h1 className='text-3xl font-semibold ml-160 mt-20'>About Us</h1>
      <motion.div className='flex gap-6 mb-8'
        ...
        <h1 className='text-2xl font-semibold text-[#146A5D] ml-10 mb-4 mt-6 ml-60'>Our Aims</h1>
        <p className='ml-10 text-gray-600 text-sm md:w-2/4 ml-60'>Our vision at Green City Hospital is to redefine the healthcare experience by making it accessible, personalized, and hassle-free for everyone. We are dedicated to connecting patients with the right care at the right time, ensuring that you always have the support you need to live your healthiest life.</p>
      </motion.div> 
        </div>
      </motion.div>
      <motion.div className='mb-8'
  ...
  <div className='flex gap-4'>
    ...
    {/* Efficiency Section */}
    <motion.div className='border-2 border-[#146A5D] rounded-lg p-4 flex-1 text-center shadow-lg'
