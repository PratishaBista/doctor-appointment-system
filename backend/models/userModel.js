...
const userSchema = new mongoose.Schema({
  ...
  email: { type: String, required: true, unique: true }, //for patients login
  ...
  image: {
    type: String,
    default: function () {
      return `https://robohash.org/${this.email}.png?size=150x150`;
    },
  },
...
const userModel = mongoose.models.user || mongoose.model("user", userSchema); // collection name: doctors
