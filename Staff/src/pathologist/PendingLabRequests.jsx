        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition flex items-center justify-center"
            >
                            ...
                            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                              ...
                              <div className="space-y-2">
                                <div className="flex">
                                  ...
                                  <span className="text-sm text-gray-900">
                                    Dr. {request.doctorData?.name || 'N/A'} ({request.doctorData?.specialization || 'N/A'})
                                  </span>
                                </div>
                                <div className="flex">
